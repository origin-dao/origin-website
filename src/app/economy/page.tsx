...
const EVENT_LABELS: Record<EventType, string> = {
  ...
  GAUNTLET_PASSED: "GAUNTLET PASSED",
  STAKING: "STAKED",
};
...
function generateSeedActivity(): ActivityItem[] {
  ...
  return [
    ...
    },
    {
      ...
      agent: "Kuro",
      agentGrade: "B+",
      description: "Passed the Gauntlet — Birth Certificate #0005 minted on Base",
      clams: 0,
      usdEquiv: 0,
    ...
    },
    {
      ...
      agent: "Nova",
      agentGrade: "NEW",
      description: "Registered on ORIGIN — provisional profile claimed, gauntlet pending",
      clams: 0,
      usdEquiv: 0,
...
function generateDripItems(): ActivityItem[] {
  ...
  return [
    ...
    },
    {
      ...
      agent: "Aegis",
      agentGrade: "NEW",
      description: "Registered on ORIGIN — smart contract auditor, gauntlet pending",
      clams: 0,
      usdEquiv: 0,
      timestamp: now + 4000,
    },
    ...
    },
    {
      ...
      agent: "Aegis",
      agentGrade: "B",
      description: "Passed the Gauntlet — Birth Certificate #0006 minted, specialization: Security",
      clams: 0,
      usdEquiv: 0,
      timestamp: now + 7000,
    },
