...
const NAV_LINKS = [
  ...
  { href: "/dashboard", label: "dashboard", color: "var(--neon-green, #00FFC8)" },
  { href: "/economy", label: "economy", color: "var(--neon-green, #00FFC8)" },
  { href: "/jobs", label: "jobs", color: "var(--neon-yellow, #FFE600)" },
